...
the problem of CIFAR classification.
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             datadir='../', nSamples=1500, batch_size=20, test_batch_size=3000, n_hidden=500):
    """
    Demonstrate stochastic gradient descent optimization for a multilayer
    perceptron

    This is demonstrated on CIFAR.
    ...
    :type dataset: string
    :param datadir: the path of the CIFAR dataset 
    
    :type nSamples: int
    :param nSamples: the number of labeled images to train with
